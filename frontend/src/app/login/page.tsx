...
import { Sparkles, Shield, UserCheck, ArrowRight, Loader2, Lock, Mail, User as UserIcon } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-card rounded-3xl p-8 border border-slate-800 shadow-2xl relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-indigo-600 to-purple-600 flex items-center justify-center text-white mx-auto mb-3 shadow-lg shadow-indigo-500/30">
        ...
        <div className="mb-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold text-sm shadow-lg shadow-amber-500/25 active:scale-95 transition-all"
          >
            {guestLoading ? (
              ...
              <>
                ...
                <span>Instant 1-Click Guest Demo Login</span>
